...
export const CAPITAL_PARTNER_LABELS = {
  ...
  CDL_CP_FIRSTNAME: 'Capital Partner Name',
  ...
  // Unit Details
  CDL_CP_UNIT_DETAILS: 'Unit Details',
  CDL_CP_FLOOR: 'Floor Number',
  CDL_CP_NOOF_BED: 'Number of Bedrooms',
  CDL_CP_UNIT_NUMBER: 'Unit fjkjkajkl (Oqood Format)',
...
export const getCapitalPartnerLabelsByCategory = (category) => {
  const categories = {
    ...
    contact: ['CDL_CP_TELEPHONE', 'CDL_CP_MOBILE', 'CDL_CP_EMAIL'],
    unit_details: [
      'CDL_CP_UNIT_DETAILS',
      'CDL_CP_FLOOR',
      'CDL_CP_NOOF_BED',
    ...
    agent: ['CDL_CP_AGENT_NAME', 'CDL_CP_AGENT_ID'],
    pricing: [
      'CDL_CP_NET_PRICE',
      'CDL_CP_GROSS_PRICE',
    ...
    status: ['CDL_CP_FEE_REQ', 'CDL_CP_WORLD_STATUS'],
  }
