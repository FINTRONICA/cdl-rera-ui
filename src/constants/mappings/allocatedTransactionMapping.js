...
export const getAllocatedTransactionTableColumns = () => {
  return [
    ...
    {
      configId: 'CDL_TRANS_ASSET_REGISTER_CIF',
      key: 'assetRegisterAccountId',
      label: getAllocatedTransactionLabel('CDL_TRANS_ASSET_REGISTER_CIF'),
      type: 'text',
      width: 'w-48',
      sortable: true,
    },
    {
      configId: 'CDL_TRANS_ASSET_REGISTER_NAME',
      key: 'assetRegisterName',
      label: getAllocatedTransactionLabel('CDL_TRANS_ASSET_REGISTER_NAME'),
      type: 'text',
      width: 'w-48',
      sortable: true,
    },
    {
      configId: 'CDL_TRANS_MF_NAME',
      key: 'managementFirmName',
      label: getAllocatedTransactionLabel('CDL_TRANS_MF_NAME'),
      type: 'text',
      width: 'w-48',
      sortable: true,
    },
    {
      configId: 'CDL_MF_REGULATOR_ID',
      key: 'managementFirmRegulatorId',
      label: getAllocatedTransactionLabel('CDL_MF_REGULATOR_ID'),
      type: 'text',
      width: 'w-40',
      sortable: true,
    },
