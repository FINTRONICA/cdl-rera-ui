...
export const PROCESSED_TRANSACTION_LABELS = {
  ...
  CDL_TRANS_ASSET_REGISTER_CIF: 'Asset Register CIF',
  CDL_TRANS_BP_NAME: 'Asset Register Name',
...
export const PROCESSED_TRANSACTION_LABELS_BY_CATEGORY = {
  ...
  BUILD_PARTNER: {
    CDL_TRANS_ASSET_REGISTER_NAME: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_ASSET_REGISTER_NAME,
    CDL_TRANS_ASSET_REGISTER_CIF: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_ASSET_REGISTER_CIF,
    ...
    CDL_TRANS_MF_NAME: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_MF_NAME,
    CDL_TRANS_MF_REGULATOR: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_MF_REGULATOR,
    CDL_MF_NAME: PROCESSED_TRANSACTION_LABELS.CDL_MF_NAME,
    CDL_MF_REGULATOR_ID: PROCESSED_TRANSACTION_LABELS.CDL_MF_REGULATOR_ID,
  },
  ACTIONS: {
