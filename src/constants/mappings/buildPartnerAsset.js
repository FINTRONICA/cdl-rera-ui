...
export const BUILD_PARTNER_ASSET_LABELS = {
  ...
  CDL_BPA_RES_PAYMENT_TYPE: 'Restricted Payment Type222',
  ...
  CDL_BPA_TL: 'Team Lead Name09876',
  CDL_BPA_DOC_VALIDITY: 'Document Validity Date',

  // Account Details
  CDL_BPA_ACC_NO: 'Trust Account Number111',
  CDL_BPA_ACC_IBAN: 'IBAN111',
  CDL_BPA_ACC_OPENDATE: 'Account Opening Date111',
  CDL_BPA_ACC_NAME: 'Account Name111',
  CDL_BPA_ACC_CUR: 'Account Currency111',
...
export const getBuildPartnerAssetLabelsByCategory = (category) => {
  const categories = {
    ...
    account: [
      ...
      'CDL_BPA_ACC_NAME',
      'CDL_BPA_ACC_CUR',
      'CDL_BPA_ACC_RETENTION',
      'CDL_BPA_ACC_SUBCONS',
      'CDL_BPA_ACC_CORP',
      'CDL_BPA_ACC_VALIDATION',
    ],
    beneficiary: [
      'CDL_BPA_BENE_INFO',
      'CDL_BPA_BENE_EXP',
      'CDL_BPA_BENE_TRANSFER',
      'CDL_BPA_BENE_REFID',
      'CDL_BPA_BENE_NAME',
      'CDL_BPA_BENE_BANK',
      'CDL_BPA_BENE_ACC',
      ...
      'CDL_BPA_BENE_SWIFT',
      'CDL_BPA_ACC_VAL',
      'CDL_BPA_BENE_DOC_TEMPLATE',
      'CDL_BPA_BENE_UPLOAD_BENE',
    ],
    payment_plan: [
      'CDL_BPA_PAYMENT_PLAN',
