          ...
          >
            <Grid container spacing={2}>
              <Grid size={{ xs: 6 }}>
                ...
                >
                  {getLabel('CDL_MF_CANCEL', language, 'Cancel')}
                </Button>
              </Grid>
              <Grid size={{ xs: 6 }}>
                <Button
                ...
                >
                  ...
                  updateBeneficiaryMutation.isPending
                    ? editingBeneficiary?.id
                      ? getLabel('CDL_MF_UPDATING', language, 'Updating...')
                      : getLabel('CDL_MF_ADDING', language, 'Adding...')
                    : editingBeneficiary?.id
                      ? getLabel('CDL_MF_UPDATE', language, 'Update')
                      : getLabel('CDL_MF_ADD', language, 'Add')}
                </Button>
              </Grid>
            </Grid>
          </Box>
